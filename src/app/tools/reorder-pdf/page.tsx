...
export default function ReorderPdfPage() {
  ...
  const hasChanges = !isDefaultOrder;
  ...
  const handleProcess = useCallback(async () => {
    ...
    try {
      const processResult = await reorderPdf(file, activePages, (update) => setProgress(update));
      ...
      {stage === "done" && result && (
        <>
          <DownloadView
            ...
            fileSize={formatFileSize(result.reorderedSize)}
